...
const UserFormPage = () => {
    ...
    useEffect(() => {
        ...
        // Fetch roles
        axios.get('http://localhost:8081/api/roles', { headers: { Authorization: `Bearer ${token}` } })
        ...
        // If edit, fetch user
        if (isEdit) {
            axios.get('http://localhost:8081/api/users', { headers: { Authorization: `Bearer ${token}` } })
                .then(res => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isEdit) {
                await axios.put(`http://localhost:8081/api/users/${id}`, payload, {
